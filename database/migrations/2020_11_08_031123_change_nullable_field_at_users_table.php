...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->longText('adddress_one')->nullable()->change();
            $table->longText('adddress_two')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
             $table->longText('adddress_one')->nullable(false)->change();
            $table->longText('adddress_two')->nullable(false)->change();
