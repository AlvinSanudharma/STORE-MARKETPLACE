      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="/images/dashboard-logo-store.svg" alt="" class="my-4" />
          </div>
          <div class="list-group list-group-flush">
            ...
            <a href="{{ route('dashboard-setting-store') }}" class="list-group-item list-group-item-action {{ (request()->is('dashboard/setting*')) ? 'active' : '' }}"
              >Store Settings</a
            >
            <a href="{{ route('dashboard-setting-account') }}" class="list-group-item list-group-item-action {{ (request()->is('dashboard/account*')) ? 'active' : '' }}"
              >My Account</a
            >
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav d-none d-lg-flex ml-auto">
                  ...
                  <li class="nav-item">
                            ...
                            @endphp
                            @if ($carts > 0)
                                <img src="images/cart-filled-ic.svg" alt="" />
                                <span class="card-badge">{{ $carts }}</span>
                            @else
                                <img src="images/cart-empty-ic.svg" alt="" />
                            @endif
                            </a>
                        </li>
                </ul>
