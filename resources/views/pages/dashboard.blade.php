                    ...
                    >
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-1">
                            <img
                              src="/images/dashboard-ic-product-1.png"
                              alt=""
                            />
                          </div>
                          ...
                          <div class="col-md-1 d-done d-md-block">
                            <img src="/images/dashboard-ic-more.svg" alt="" />
                          </div>
                        </div>
                      </div>
                    </a>
                    ...
                    >
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-1">
                            <img
                              src="/images/dashboard-ic-product-2.png"
                              alt=""
                            />
                          </div>
                    ...
                    >
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-1">
                            <img
                              src="/images/dashboard-ic-product-3.png"
                              alt=""
                            />
                          </div>
