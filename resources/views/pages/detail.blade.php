                            ...
                            <div class="col-lg-2" data-aos="zoom-in">
                                @auth
                                    <form action="{{ route('detail-add', $product->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                            <button
                                            class="btn btn-success px-4 btn-block text-white mb-3" type="submit">
                                            Add to Cart 
                                            </button>
                                    </form>
                                @else
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <img
                                            src="/images/testimonial_ic_1.png"
                                            alt=""
                                    ...
                                    <li class="media">
                                        <img
                                            src="/images/testimonial_ic_2.png"
                                            alt=""
                                            class="mr-3 rounded-circle"
                                        />
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img
                                            src="/images/testimonial_ic_3.png"
                                            alt=""
                                            class="mr-3 rounded-circle"
                                        />
                                        <div class="media-body">
